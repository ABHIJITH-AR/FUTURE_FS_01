    ...
    case "mongodb":
      return (
        <svg viewBox="0 0 24 24" width={size} height={size} className={className} fill="none">
          <path
            fill="#47A248"
            d="M17.193 9.42c-.733-3.618-3.042-6.575-4.81-8.913-.198-.261-.571-.261-.769 0-1.768 2.338-4.077 5.295-4.81 8.913-1.023 5.056.883 9.945 4.887 12.358.196.118.442.118.638 0 4.004-2.413 5.91-7.302 4.864-12.358z"
          />
          <path
            fill="#499D4A"
            d="M11.998 23.957v-23.45c.198.261.571.261.769 0 1.768 2.338 4.077 5.295 4.81 8.913 1.046 5.056-.86 9.945-4.864 12.358-.225.136-.48.161-.715.179z"
          />
          <path
            fill="#E8E8E8"
            d="M11.998 23.957c.078-.006.155-.021.231-.05.196-.118.442-.118.638 0-4.004-2.413-5.91-7.302-4.887-12.358.733-3.618 3.042-6.575 4.81-8.913-.198-.261-.571-.261-.769 0-1.768 2.338-4.077 5.295-4.81 8.913-1.023 5.056.883 9.945 4.887 12.358.076.029.153.044.231.05z"
            opacity="0.1"
          />
        </svg>
      );
